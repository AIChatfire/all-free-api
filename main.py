...
from free_api.routers.async_tasks import async_dynamic_tasks_for_sync as async2sync_dynamic_tasks
...
app.include_router(async2sync_dynamic_tasks.router, '/async2sync', tags=async2sync_dynamic_tasks.TAGS)
